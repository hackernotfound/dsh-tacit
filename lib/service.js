...
function coachErrorCode(error) {
  ...
  // ladder now sees the raw code and message of every provider failure.
  if (/\brate[ _-]?limit|\bquota\b|\b429\b|too[ _-]?many[ _-]?requests/i.test(text)) return 'rate-limited'
  return 'call-failed'
}
